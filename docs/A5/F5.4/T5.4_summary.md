...
### 1. Network Gating Check
**File:** `apex/eval/harness.py:96-101`
```python
...
### 2. _run_swe_episode Implementation  
**File:** `apex/eval/harness.py:349-390`
```python
...
### 3. apply_patch with --3way
**File:** `apex/eval/repo_manager.py:324-334`
```python
...
### 4. Frozen Task List Filtering
**File:** `apex/eval/harness.py:192-200`
```python
...
### 5. Best Static Filter
**File:** `scripts/pick_best_static.py:54-80`
```python
...
### 6. Per-Task Virtual Environment
**File:** `apex/eval/repo_manager.py:149-175`
```python
...
$ python3 -m scripts.validate_swe_jsonl \
    --inputs docs/A5/artifacts/swe/dev/static_star_dev_sample100.jsonl \
             docs/A5/artifacts/swe/dev/static_chain_dev_sample100.jsonl \
             docs/A5/artifacts/swe/dev/static_flat_dev_sample100.jsonl \
             docs/A5/artifacts/swe/dev/static_best_dev_sample100.jsonl \
             docs/A5/artifacts/swe/dev/apex_dynamic_dev_sample100.jsonl \
    --task-list docs/A5/artifacts/swe/dev/task_list_dev_sample100.jsonl

Individual file validation:
--------------------------------------------------
static_star_dev_sample100.jsonl ✅ 100 records
static_chain_dev_sample100.jsonl ✅ 100 records
static_flat_dev_sample100.jsonl ✅ 100 records
static_best_dev_sample100.jsonl ✅ 100 records
apex_dynamic_dev_sample100.jsonl ✅ 100 records
